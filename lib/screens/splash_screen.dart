...
import 'main_screen.dart'; // pastikan path ini benar: lib/screens/main_screen.dart
...
class _SplashScreenState extends State<SplashScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    Timer(const Duration(seconds: 3), () {
      ...
      if (auth.isLoggedIn) {
        // Panggil MainScreen widget dari file main_screen.dart
            ...
            children: [
              ...
              const Text(
                ...
                style: TextStyle(
                  ...
                  color: black,
                  shadows: [Shadow(offset: Offset(2.0, 2.0), blurRadius: 3.0, color: Color.fromARGB(80, 0, 0, 0))],
                ),
              ),
            ],
          ),
